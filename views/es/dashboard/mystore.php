...
<body>
  ...
  <main>
    ...
    <section class="profile">
      <div class="row">
        <img src="<?php echo constant("URL").'assets/profiles/'.$user->getImg(); ?>" alt="Vista previa de la imagen de perfil" title="Vista previa de la imagen de perfil" class="img">

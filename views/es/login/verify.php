...
<header><p>Confirmar cuenta</p></header>
...
<main id="verify">
  ...
  <form action="<?php echo constant('URL').$lenguage; ?>/verify/resendVerifyLink" method="GET" name="form_verify" class="form1">
    <ol>
      <li>
        <label for="email">Reenviar email de verificacion: </label>
      </li>
      <li>
        <input type="email" name="email" id="email" placeholder="E-mail" title="Email">
      </li>
      <li>
        <button type="button" id="validate" title="Reenviar validacion">
  ...
  <?php if ($show == "login") { ?>
    <button class="button">
      <a href="<?php echo constant('URL').$lenguage; ?>/login" id="login" title="Iniciar Sesion">Iniciar Sesion</a>
    </button> 

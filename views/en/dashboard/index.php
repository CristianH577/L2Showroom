    ...
    <section id="profile">
      <div class="row">
        <div>
          <?php 
            ...
            $previewALT = "Profile picture of".$user->getNick();
          ...
          <div class="center" id="actions_profile_img">
            <button type="button" title="Delete profile picture" id="delete_img">
      ...
      <ul>
        ...
        <li>
          ...
          <input type="text" name="nick" id="nick" placeholder="Nick*" value="<?php echo $user->getNick(); ?>" title="Nick">
        </li>
        <li>
        ...
        <div id="change_data">
          ...
          <li>
            <div class="password">
            <input type="password" name="new_password" id="new_password" placeholder="New password" autocomplete="off" title="New password">
            <svg class="svg_password" onclick="seePassword('new_password')"><path d="M12 9a3.02 3.02 0 0 0-3 3c0 1.642 1.358 3 3 3 1.641 0 3-1.358 3-3 0-1.641-1.359-3-3-3z"></path><path d="M12 5c-7.633 0-9.927 6.617-9.948 6.684L1.946 12l.105.316C2.073 12.383 4.367 19 12 19s9.927-6.617 9.948-6.684l.106-.316-.105-.316C21.927 11.617 19.633 5 12 5zm0 12c-5.351 0-7.424-3.846-7.926-5C4.578 10.842 6.652 7 12 7c5.351 0 7.424 3.846 7.926 5-.504 1.158-2.578 5-7.926 5z"></path></svg>
            </div>
          </li>
          <li>
            <div class="password">
            <input type="password" name="confirm_new_password" id="confirm_new_password" placeholder="Confirm new password" autocomplete="off" title="Confirm new password">
            <svg class="svg_password" onclick="seePassword('confirm_new_password')"><path d="M12 9a3.02 3.02 0 0 0-3 3c0 1.642 1.358 3 3 3 1.641 0 3-1.358 3-3 0-1.641-1.359-3-3-3z"></path><path d="M12 5c-7.633 0-9.927 6.617-9.948 6.684L1.946 12l.105.316C2.073 12.383 4.367 19 12 19s9.927-6.617 9.948-6.684l.106-.316-.105-.316C21.927 11.617 19.633 5 12 5zm0 12c-5.351 0-7.424-3.846-7.926-5C4.578 10.842 6.652 7 12 7c5.351 0 7.424 3.846 7.926 5-.504 1.158-2.578 5-7.926 5z"></path></svg>
            </div>
          </li>
          <li>
            <div class="password">
              <input type="password" name="password" id="password" placeholder="Current password*" autocomplete="off" title="Current password">
          ...
          <div class="center" id="actions_profile_data">
            <button type="button" id="update" title="Save changes">
            ...
            <button type="button" id="resetForm" title="Reset form">
            ...
            <button type="button" id="cancel" title="Cancel edition">
              <svg class="svg1"><path d="M9.172 16.242 12 13.414l2.828 2.828 1.414-1.414L13.414 12l2.828-2.828-1.414-1.414L12 10.586 9.172 7.758 7.758 9.172 10.586 12l-2.828 2.828z"></path><path d="M12 22c5.514 0 10-4.486 10-10S17.514 2 12 2 2 6.486 2 12s4.486 10 10 10zm0-18c4.411 0 8 3.589 8 8s-3.589 8-8 8-8-3.589-8-8 3.589-8 8-8z"></path></svg>
            </button>
          </div>
        </div>
      ...
      <div class="center" id="actions">
        ...
        data-msg="Are you sure you want to PERMANENTLY DELETE your account??" 
        ...
        <button type="button" id="edit" title="Edit profile">
          <svg class="svg1">

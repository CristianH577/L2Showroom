    ...
    <ol>
      <li>
        <ul>
          ...
          <li>
            <input type="text" name="name" id="name" placeholder="Name*" title="Name">
          </li>
          <li>
            <input type="text" name="subject" id="subject" placeholder="Subject*" title="Subject">
          </li>
          <li>
            <textarea name="contact_message" id="contact_message" cols="30" rows="10" placeholder="Message*" title="Message"></textarea>
          </li>
        </ul>
      </li>
      
      <button type="button" title="Send Message" id="send">

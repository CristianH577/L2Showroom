  ...
  <main id="login">
    ...
    <form action="<?php echo constant('URL').$lenguage; ?>/login/authenticate" method="POST" name="login" class="form1">
      <ol>
          ...
          <ul>
            ...
            <li>
              <label class="content-input">
                <input type="checkbox" name="remember_user" id="remember_user" hidden>Keep session open
                <i title="Keep session open"></i>
              </label>
            </li>
          </ul>
        </li>
        <li>
          <button type="button" title="Log in" id="log">
        ...
        <li>
          <p>You do not have an account? <a href="<?php echo constant('URL').$lenguage; ?>/signup" title="Register">Register</a></p>
        </li>
      </ol>
    </form>
    </div>

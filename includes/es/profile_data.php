...
<div class="row">
    <?php 
        echo '<img src="'.constant("URL").'assets/profiles/'.$orders_list[0]['img_user'].'" class="img" alt="Imagen de perfil de '.$orders_list[0]['nick'].'" title="Imagen de perfil de '.$orders_list[0]['nick'].'">';
    ?>
